...
interface ErrorBoundaryProps {
    ...
    fallback?: ReactNode; // optional: a custom error UI to show // if not provided, the default error box is used 
} 
        ...
        // If caller gave us a custom error UI, show that instead 
            ...
            return ( 
                <div style={{ padding: 24, border: '1px solid #FCA5A5', borderRadius: 8, background: '#FEF2F2', color: '#991B1B', }}>
                    ...
                    style={{ padding: '6px 14px', border: '1px solid #FCA5A5', borderRadius: 4, background: '#fff', cursor: 'pointer', color: '#991B1B', }} > 
                        Try Again 
                    </button> 
                </div> 
            );
