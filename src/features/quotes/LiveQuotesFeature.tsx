...
const LiveQuotesFeature: React.FC = () => {
    ...
    const { 
        ...
        setSectorFilter, 
        setSelectedStock 
    } = useStockStore(useShallow((s) => ({
        searchQuery: s.searchQuery,
        sectorFilter: s.sectorFilter,
        filteredStocks: s.filteredStocks,
        selectedStock: s.selectedStock,
        setSearchQuery: s.setSearchQuery,
        setSectorFilter: s.setSectorFilter,
        setSelectedStock: s.setSelectedStock
    })));

    // 2. Pass filteredStocks to the virtualizer, NOT allStocks
    const { 
        visibleItems, 
        containerRef, 
        spaceAbove, 
    ...
    return (
        <> 
            {/* 3. Connect SearchBar to store actions */}
            <SearchBar 
            ...
            {/* 4. Use selectedStock and setSelectedStock from store */}
            ...
            <div ref={containerRef} style={{ height: CONTAINER_HEIGHT, overflowY: 'auto', border: '1px solid #E5E7EB', borderRadius: 6 }}> 
                <table style={{ width: '100%', borderCollapse: 'collapse' }}> 
                    ...
                    <tbody> 
                        {spaceAbove > 0 && (<tr><td colSpan={6} style={{ height: spaceAbove, padding: 0 }} /></tr>)} 
                        ...
                        {spaceBelow > 0 && (<tr><td colSpan={6} style={{ height: spaceBelow, padding: 0 }} /></tr>)} 
                    </tbody> 
                </table> 
            </div> 
