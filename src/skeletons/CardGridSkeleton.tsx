...
const shimmerStyle: React.CSSProperties = { 
    background: 'linear-gradient(90deg, #f0f0f0 25%, #e0e0e0 50%, #f0f0f0 75%)', backgroundSize: '400px 100%', animation: 'shimmer 1.4s ease-in-out infinite', borderRadius: 4, 
}
    ...
    return ( 
        <div> 
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 16, marginBottom: 24, }}> 
                ...
                return ( 
                    <div key={cardIndex} style={{ border: '1px solid #D1D5DB', borderRadius: 8, padding: 16, }}> 
                    ...
                    {/* Line 4: Sector */ } 
                    <div style={{ ...shimmerStyle, height: 12, width: '35%' }} /> </div > ); 
                    })} 
            </div > 
        </div > 
    ); 
